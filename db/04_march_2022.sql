...
INSERT INTO `event_master` (`EM_Id`, `CreatedBy`, `EventName`, `EventCode`, `StartDate`, `StartTime`, `EndDate`, `EndTime`, `EventLocation`, `TotalSeats`, `AgeLimit`, `Organizer`, `PrintedBy`, `EventStatus`, `DateCreate`, `EventBanner`, `ShortDescription`, `Description`, `Image1`, `Image2`, `Image3`, `Image4`, `EventOn`, `BookingStatus`, `SliderStatus`, `LocationMap`) VALUES
	(1, 'Admin', 'KARNATAKA INDIANS', 'EHTP2021932Q', '2022-01-21', '16:35:42', '2022-01-04', '16:35:47', 'INDIAN HIGH SCHOOL-SHEIKHaaa', 803, '90aa', 'MAESTRO EVENTS LLCaa', 'MAESTRO EVENTS LLCaa', 'Publish', '2022-01-06 14:37:21', 'event-image/16462166053436.jpg', 'aaaThe Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A wit', 'aaaaThe Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16428303526680.jpg', 'event-image/16428303525115.jpg', 'event-image/16428303526510.jpg', '', '2022-01-21 16:35:42', 1, 1, 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.0611792992595!2d55.265095314446725!3d25.201159237725303!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f4378e4e75fb7%3A0xce010713d09644d1!2sMaestro%20Events%20LLC!5e0!3m2!1sen!2sin!4v1644552896938!5m2!1sen!2sin'),
	(2, 'Admin', 'SIKERAM DRIVER', 'EHTP2021962V', '2022-01-12', '14:35:44', '2022-02-10', '14:35:48', 'EMIRATES THEATER', 2000, '90', 'MAESTRO EVENTS LLC', 'MAESTRO EVENTS LLC', 'Publish', '2022-01-06 14:37:22', 'event-image/16462166817897.jpg', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an magician', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16414615511476.jpg', 'event-image/16414615664472.jpg', 'event-image/16414615667786.jpg', '', '2022-01-12 14:35:44', 1, 1, 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.0611792992595!2d55.265095314446725!3d25.201159237725303!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f4378e4e75fb7%3A0xce010713d09644d1!2sMaestro%20Events%20LLC!5e0!3m2!1sen!2sin!4v1644552896938!5m2!1sen!2sin'),
...
CREATE TABLE IF NOT EXISTS `log_master` (
  ...
  PRIMARY KEY (`LO_id`)
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=latin1 COMMENT='All user log details';

-- Dumping data for table eticketing.log_master: ~90 rows (approximately)
...
-- Dumping data for table eticketing.payment_master: ~31 rows (approximately)
...
-- Dumping data for table eticketing.price_category: ~7 rows (approximately)
...
-- Dumping data for table eticketing.sales_data: ~74 rows (approximately)
...
-- Dumping data for table eticketing.sales_master: ~18 rows (approximately)
