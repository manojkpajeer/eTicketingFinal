...
-- Dumping data for table eticketing.badge_master: ~8 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='All customer details';
...
INSERT INTO `customer_master` (`CM_Id`, `Saluation`, `FirstName`, `LastName`, `CustomerEmail`, `CustomerPhone`, `Nationality`, `DateOfBirth`, `AreaCode`, `InternationalCode`, `AddressLine1`, `AddressLine2`, `CustomerCity`, `CustomerState`, `CustomerCountry`, `CustomerStatus`, `DateCreate`, `CustomerId`, `AccountNo`) VALUES
	...
	(2, 'Mr', 'sdg', 'sgd', 'manosdgjkpajeer127@gmail.com', '5654654654', 'AE', '2021-12-31', 'sd', '971', 'sdg', 'gsd', 'gsd', 'sgd', 'AE', 1, '2022-01-31 22:21:37', '12483126', '14938386');
...
INSERT INTO `event_master` (`EM_Id`, `CreatedBy`, `EventName`, `EventCode`, `StartDate`, `StartTime`, `EndDate`, `EndTime`, `EventLocation`, `TotalSeats`, `AgeLimit`, `Organizer`, `PrintedBy`, `EventStatus`, `DateCreate`, `EventBanner`, `ShortDescription`, `Description`, `Image1`, `Image2`, `Image3`, `EventOn`, `BookingStatus`, `SliderStatus`) VALUES
	(1, 'Admin', 'KARNATAKA INDIANSs', 'EHTP2021932Q', '2022-01-21', '16:35:42', '2022-01-04', '16:35:47', 'INDIAN HIGH SCHOOL-SHEIKHaaa', 803, '90aa', 'MAESTRO EVENTS LLCaa', 'MAESTRO EVENTS LLCaa', 'Publish', '2022-01-06 14:37:21', 'event-image/16428303523864.jpg', 'aaaThe Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A wit', 'aaaaThe Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16428303526680.jpg', 'event-image/16428303525115.jpg', 'event-image/16428303526510.jpg', '2022-01-29 16:35:42', 1, 1),
	(2, 'Admin', 'SIKERAM DRIVER', 'EHTP2021962V', '2022-01-12', '14:35:44', '2022-02-10', '14:35:48', 'EMIRATES THEATER', 2000, '90', 'MAESTRO EVENTS LLC', 'MAESTRO EVENTS LLC', 'Publish', '2022-01-06 14:37:22', 'event-image/16414614618219.jpg', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an magician', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16414615511476.jpg', 'event-image/16414615664472.jpg', 'event-image/16414615667786.jpg', '2022-01-15 11:40:34', 1, 0),
	(3, 'Admin', 'AR RAHMAN SHOW', 'EHTP3520212V', '2022-01-14', '15:06:38', '2022-01-19', '15:06:21', 'MANGALORE', 1000, '90', 'MAESTRO EVENTS LLC', 'MAESTRO EVENTS LLC', 'Publish', '2022-01-06 15:05:04', 'event-image/16414621168954.jpg', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after ', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16414621164180.jpg', 'event-image/16414621167896.jpg', 'event-image/16414621166997.jpg', '2022-01-15 15:40:39', 1, 0),
	(4, 'Admin', 'ONE INDIA SHOW', 'EHTP2021962W', '2022-01-16', '15:06:39', '2022-01-18', '15:06:22', 'BANGALORE', 1500, '90', 'MAESTRO EVENTS LLC', 'MAESTRO EVENTS LLC', 'Publish', '2022-01-06 15:05:05', 'event-image/16414620946165.jpg', 'enging trivia AND an a', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16414620943489.jpg', 'event-image/16414620949467.jpg', 'event-image/16414620944221.jpg', '2022-01-15 11:49:40', 1, 0),
	(5, 'Admin', 'HEALTHY LIFE', 'EDSX2021962V', '2022-01-18', '15:06:40', '2022-01-20', '15:06:23', 'HASAN', 2000, '90', 'MAESTRO EVENTS LLC', 'MAESTRO EVENTS LLC', 'Publish', '2022-01-06 15:05:06', 'event-image/16414620691675.jpg', 'Q&A with the magician', 'The Hogwarts Express has arrived yet again! Head over to Platform 9 and join us for Harry Potter themed virtual trivia Get your Butterbeer & join us for a LIVE MAGIC SHOW from professional illusionist Chase Callahan (CHASEing the Magic) challenging trivia AND an after game Q&A with the magician', 'event-image/16414620692740.jpg', 'event-image/16414620694640.jpg', 'event-image/16414620697525.jpg', '2022-01-18 15:06:40', 1, 0),
...
CREATE TABLE IF NOT EXISTS `event_request` (
  ...
  PRIMARY KEY (`ER_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Customer request to create new event';

-- Dumping data for table eticketing.event_request: ~1 rows (approximately)
...
INSERT INTO `event_request` (`ER_Id`, `OrganizerName`, `Phone`, `Email`, `EventName`, `EventDate`, `StartTime`, `EndTime`, `EventVenue`, `EventProfile`, `Attendees`, `Badges`, `Amount`, `Celebrity`, `Fund`, `EventType`, `DateCreate`, `Registration`, `UniqueId`) VALUES
	(1, 'dsfsd', '547457547554', 'manojkpajeer127@gmail.com', 'dfgdf', '2022-01-31', '12:26:00', '12:26:00', 'dfgfdg', 'sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa sdfsafsafasfsafasfsa ', '634', 'Yes', 43543.000000, 'Yes', 'Yes', 'Business', '2022-01-31 12:27:25', 'No', '1643697752'),
	(2, 'dsf', '8904653245', 'manojkpajeer127@gmail.com', 'Event test name', '2022-02-01', '12:17:00', '12:17:00', 'fhg', '', '435', 'No', 0.000000, 'Yes', 'Yes', 'Business', '2022-02-01 12:17:39', 'Yes', '1643698059');
...
CREATE TABLE IF NOT EXISTS `login_master` (
  ...
  PRIMARY KEY (`LM_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 COMMENT='All users login details';
...
CREATE TABLE IF NOT EXISTS `log_master` (
  ...
  PRIMARY KEY (`LO_id`)
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=latin1 COMMENT='All user log details';

-- Dumping data for table eticketing.log_master: ~91 rows (approximately)
...
-- Dumping data for table eticketing.payment_master: ~32 rows (approximately)
...
-- Dumping data for table eticketing.price_category: ~5 rows (approximately)
...
-- Dumping data for table eticketing.sales_data: ~76 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `token_master` (
  ...
  PRIMARY KEY (`TM_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 COMMENT='All token details';
