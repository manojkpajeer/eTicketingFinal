...
INSERT INTO `ajent_master` (`AJM_Id`, `AjentEmail`, `AjentStatus`, `AjentCode`, `FullName`, `DateCreate`, `AjentPhone`, `Address`, `AjentProfile`) VALUES
	(1, 'manu.mobile127@gmail.com', 1, 'AJE1001a', 'Subhashaaaa', '2021-12-26 21:56:48', '8547854561', 'Mangalore, Konaje1', 'assets/images/profileimg.jpg');
...
CREATE TABLE IF NOT EXISTS `badge_master` (
  ...
  PRIMARY KEY (`BD_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='All badge details';
...
CREATE TABLE IF NOT EXISTS `log_master` (
  ...
  PRIMARY KEY (`LO_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='All user log details';

-- Dumping data for table eticketing.log_master: ~11 rows (approximately)
...
INSERT INTO `payment_master` (`RP_Id`, `RazorPayOredrId`, `RazorPayPaymentId`, `PaymentStatus`, `DatePaid`, `TotalAmount`, `CustomerId`, `PaymentMessage`) VALUES
	(1, '7568768ifhsdknfksd', '55765JHG', 'Paid', '2022-01-12 11:16:29', 90.000000, 1, 'Payment successfull..'),
	(2, '7568768ifhsdknfksdased', '785ADD', 'Paid', '2022-01-12 11:18:19', 800.000000, 1, 'Payment successfull..');
...
INSERT INTO `sales_data` (`SD_Id`, `CategoryId`, `TypeId`, `Quantity`, `Status`, `EventId`, `BusketId`, `DateCreate`) VALUES
	...
	(2, 1, 2, 8, 1, 2, '15241324', '2022-01-12 13:25:31');
...
CREATE TABLE IF NOT EXISTS `ticket_allocation` (
  ...
  `Quantity` double DEFAULT NULL,
  PRIMARY KEY (`TA_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='Number of tickets assigned to ajents';

-- Dumping data for table eticketing.ticket_allocation: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `token_master` (
  ...
  PRIMARY KEY (`TM_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='All token details';
