<?php
    ...
    if (isset($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE staff_master, login_master FROM staff_master INNER JOIN login_master ON  staff_master.EmailId = login_master.UserEmail WHERE staff_master.ST_Id = '$_GET[did]'")){
            ...
            echo "<script>alert('Yay, Staff deleted successfully..');location.href='manage-staff.php';</script>";     
        } else {

            echo "<script>alert('Oops, Unable to delete staff.');</script>";
        }
    }
            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    <div class="card card_border p-4 border-primary-top">
                        <h3 class="card__title position-absolute">Manage Staff</h3>
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo "Manage Staff - ".$rowd6['FullName'];?></h5>
