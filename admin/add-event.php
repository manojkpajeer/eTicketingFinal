    ...
    if(isset($_POST['add'])){
        ...
        if(mysqli_num_rows($res)>0){
            ...
            if (move_uploaded_file($_FILES['event_banner']['tmp_name'], "../superadmin/".$path_banner)) {
                ...
                Description, Image1, Image2, Image3, EventOn, BookingStatus, SliderStatus, LocationMap) VALUES ('$_SESSION[FullName]', '$_POST[event_name]', '$_POST[event_code]', 
                ...
                '$_POST[description]', '$path_image1', '$path_image2', '$path_image3', '$eventOn', '$_POST[bookingstatus]', '$_POST[slider_status]', '$_POST[map]')")){
