                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $resd6 = mysqli_query($conn, "SELECT sales_master.BasketId, sales_master.OrderId, sales_master.DateCreate, sales_master.SM_Id, 
                                            sales_master.SalesStatus, customer_master.FirstName, customer_master.Saluation, customer_master.LastName FROM sales_master 
                                            JOIN customer_master ON customer_master.CM_Id = sales_master.CustomerId WHERE sales_master.EventId = '$_GET[id]' AND IsSoldByAjent = false ORDER BY 
