<?php
    ...
    $resimg = mysqli_query($conn, "SELECT ProfileImage FROM staff_master WHERE ST_Id = ' " . $_SESSION['st_id'] . " '");
    ...
    if(isset($_POST['update'])){
        ...
        if (move_uploaded_file($_FILES['profile_image']['tmp_name'], $path)) {
            if (mysqli_query($conn, "UPDATE staff_master SET ProfileImage = '$path' WHERE ST_Id = ' " . $_SESSION['st_id'] . " ' ")) {
