<?php
    ...
    if(mysqli_num_rows($resReport) > 0 ){
        ...
        echo "<script>alert('Oops, unable to process...');location.href='after-event.php';</script>";
    }
          ...
          <?php
                ...
                if(mysqli_num_rows($rescat)>0){
                    while($resReportcat = mysqli_fetch_assoc($rescat)){
                        ...
                        $ticketSold = 0;
                        $resSold = mysqli_query($conn, "SELECT COALESCE(SUM(Quantity), 0) AS Quantity FROM sales_data WHERE CategoryId = '$resReportcat[PriceCategoryId]' AND EventId = '$resReport[EM_Id]' AND Status = true");
                        if (mysqli_num_rows($resSold)>0){

                            $resSold = mysqli_fetch_assoc($resSold);
                            $ticketSold = $resSold['Quantity'];
                        }
                        ?>
                            <div class="row mt-3 py-2" style="border-top: dashed 2px #000;">
                                <div class="col-4">
                                        ...
                                        <?php echo $resReportcat['SeatsNo'] -$ticketSold ;?> avails, &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ticketSold; ?> unavails,<br>
                                        0 HOLDS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0 @ H<br>
                                        0 COMPS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0 @ C<br><br>
                                        <?php
                                ...
                                <div class="col-4 text-center"><br><?php
                                    echo $ticketSold;
                                ?> SOLD &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $resReportcat['SeatsNo'];?> CAP</div>
                ...
                if(mysqli_num_rows($rescat2)>0){
                    while($resReportcat2 = mysqli_fetch_assoc($rescat2)){
                        ...
                        $ticketSold = 0;
                        $resSold = mysqli_query($conn, "SELECT COALESCE(SUM(Quantity), 0) AS Quantity FROM sales_data WHERE CategoryId = '$resReportcat2[PriceCategoryId]' AND EventId = '$resReport[EM_Id]' AND Status = true");
                        if (mysqli_num_rows($resSold)>0){
                        ...
                        ?>
                            <div class="row mt-3 py-2" style="border-top: dashed 2px #000;">
                                <div class="col-4">
                                        ...
                                        <?php echo $resReportcat2['SeatsNo']-$ticketSold;?> avails, &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ticketSold; ?> unavails,<br>
                                        0 HOLDS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0 @ H<br>
                                        0 COMPS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0 @ C<br><br>
                                        <?php
                                ...
                                <div class="col-4 text-center"><br><?php
                                    echo $ticketSold;
                                ?> SOLD &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $resReportcat2['SeatsNo'];?> CAP</div>
