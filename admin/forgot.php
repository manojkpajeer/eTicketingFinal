<?php 
    ...
    if (isset($_POST['reset'])) {
        ...
        $res = mysqli_query($conn, "SELECT login_master.UserPassword, staff_master.FullName  FROM login_master JOIN staff_master ON staff_master.EmailId = login_master.UserEmail WHERE login_master.UserEmail = '$email' AND staff_master.StaffStatus = 1");
