<?php
    ...
    function sendEmail($name, $email, $password) {
        ...
        try {                   
            ...
            $mail->IsHTML(true);
            $mail->Subject = "Staff Creation - DXB Tickets";
            ...
            if ($mail->send()) {
                ...
                echo "<script>alert('Oops, Staff Created successfully but unable to send an email..');</script>";
            }
        } catch (Exception $e) {
    ...
    <div class="container-fluid content-top-gap">
        <div class="row">
            <div class="col-xl-12 pr-xl-12">
                ...
                <div class="card-header chart-grid__header float-left">Add Staff</div>
                    <div class="card-body">
