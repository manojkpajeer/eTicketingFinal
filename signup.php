<?php
    ...
    if (isset($_POST['register'])) {
        $api = new MaestroUtil();
        $resreg = mysqli_query($conn, "SELECT CM_Id FROM customer_master WHERE CustomerEmail = '$_POST[email]' OR CustomerPhone = '$_POST[phone]' AND CustomerStatus = 1");
        if (mysqli_num_rows($resreg)>0) {
            echo "<script>alert('Oops, Email ID or Phone Number already exist..');</script>";
        } else {
            if($api->createNewCustomer(
                $_POST['saluation'],
                $_POST['first_name'],
                $_POST['last_name'],
                $_POST['email'],
    ...
    function sendEmail($saluation, $fname, $lname, $email) {

        try {    

            $customerName = $saluation . " " . $fname . " " . $lname;
            ...
            $mail->IsHTML(true);
            $mail->Subject = "User creation email - Maestro Events";
            $mail->Body = 'hi ' . $customerName . "<br> Thank you for signing with us.<br>Thank you again<br><strong>Team DXB Tickets</strong>";
                ...
                <div class="form23">
                    ...
                    <form action="" method="POST" class="row g-3 needs-validation" novalidate>
                        <div class="col-md-4">
                            ...
                            <select class="form-control input-style" id="validationCustom01" name="saluation">
                        ...
                        <div class="col-md-4">
                            <label for="validationCustom02" class="form-label text-light">First Name</label>
                            <input type="text" class="form-control input-style" id="validationCustom02" name="first_name" pattern="[A-Za-z]{1,49}" maxlength="49">
                            <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control input-style" id="validationCustom01" required name="last_name" pattern="[A-Za-z]{1,49}" maxlength="49">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Email ID <span class="text-danger">*</span></label>
                                <input type="email" class="form-control input-style" id="validationCustom02" required name="email" maxlength="99">
                                <div class="invalid-feedback">
                                Enter valid email id
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">International Code</label>
                                <input type="text" value="971" class="form-control input-style" id="validationCustom02" name="international_code" maxlength="10">
                                <div class="invalid-feedback">
                                Please enter valid international code 
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Phone (max 10 digit)<span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-style" id="validationCustom02" required name="phone" pattern="[0-9]{1,10}" maxlength="10">
                                <div class="invalid-feedback">
                                Enter valid phone
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Nationality <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Date Of birth <span class="text-danger">*</span></label>
                                <input type="date" class="form-control input-style" id="validationCustom02" name="dateofbirth" max="<?php echo date('Y-m-d', strtotime("-18 year", time())); ?>" required>
                                <div class="invalid-feedback">
                                Choose valid birth date
                                </div>
                            </div>
                            
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Address Line 1</label>
                                <input type="text" class="form-control input-style" id="validationCustom02" name="address_line1" maxlength="245">
                                <div class="invalid-feedback">
                                Please enter address line1
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Address Line 2</label>
                                <input type="text" class="form-control input-style" id="validationCustom02" name="address_line2" maxlength="245">
                                <div class="invalid-feedback">
                                Please enter address line2
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">City <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-style" id="validationCustom02" name="city" required maxlength="49">
                                <div class="invalid-feedback">
                                Please enter city
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">State <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-style" id="validationCustom02" name="state" required maxlength="49">
                                <div class="invalid-feedback">
                                Please enter state
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Country <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 mt-3">
                                <label for="validationCustom02" class="form-label text-light">Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control input-style" id="validationCustom02" name="password" required maxlength="24" pattern=".{6,}">
                                <div class="invalid-feedback">
                                6 or more characters
                                </div>
                            </div>
                            <div class="form-check check-remember check-me-out ml-3 mt-4 col-12">
                                <input type="checkbox" class="form-check-input checkbox" id="exampleCheck1" required>
                                <label class="form-check-label checkmark text-light" for="exampleCheck1">I agree to the
                                    <a href="#terms" class="text-info">Terms of service</a> and <a href="#privacy" class="text-info">Privacy policy</a> 
                                </label>
                                <div class="invalid-feedback">
                                Please agree our terms of service
                                </div>
                            </div>
                       
                            <button type="submit" name="register">Sign Up</button>
                        </form>
                        <h5>Are you a member? <a href="login.php" class="text-info">Login now</a></h5>
                    </div>
                </div>
            </div>
        </div>
