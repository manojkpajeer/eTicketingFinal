<?php
    ...
    $resacc = mysqli_query($conn, "SELECT * FROM admin_master WHERE AM_Id = $_SESSION[am_id]");
    ...
    if (isset($_POST['update'])) {
        if (mysqli_query($conn, "UPDATE admin_master SET FullName = '$_POST[full_name]', AdminPhone = '$_POST[phone]', Address = '$_POST[address]' WHERE AM_Id = ' " . $_SESSION['am_id'] . " '")){
                    ...
                    <div class="card-body">
                        <form method="post" class="g-3 needs-validation row" novalidate>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="email" value="<?php echo $resacc['AdminEmail'];?>" class="form-control input-style" readonly>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-5 mt-4">
                                ...
                                <input type="text" value="<?php echo $resacc['AdminPhone'];?>" class="form-control input-style" required name="phone" pattern="[0-9]{1,10}" maxlength="10">
                                <div class="invalid-feedback">
