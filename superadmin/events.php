<?php
    ...
    if(isset($_POST['update'])){
        ...
        if (!empty($_FILES['image4']['name'])) {
            ...
            $path4 = "event-image/" .time() . rand(1000, 9999) . "." . pathinfo($_FILES['image4']['name'], PATHINFO_EXTENSION);
            if (move_uploaded_file($_FILES['image4']['tmp_name'], $path4)) {
        ...
        Image2 = '$image2', Image3 = '$image3', Image4 = '$image4', EventOn = '$eventOn', BookingStatus = '$_POST[bookingstatus]', 
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="modal-body g-3 row">
                                                                        ...
                                                                        <input type="hidden" name="image4" value="<?php echo $rowd6['Image4'];?>">
                                                                        ...
                                                                        <div class="col-md-3 mt-4">
                                                                            ...
                                                                            <input type="file" class="form-control input-style" id="i17"  name="image4" accept="image/*">
                                                                            <div class="invalid-feedback">
                                                                            Please choose image
                                                                            </div>
                                                                        </div>
