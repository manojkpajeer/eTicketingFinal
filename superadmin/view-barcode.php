            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    <div class="card card_border p-4 border-primary-top">
                        <h3 class="card__title position-absolute">View Barcode - Event List</h3>
                                    ...
                                    <?php
                                        ...
                                        if (mysqli_num_rows($resd6) > 0) {
                                            ...
                                            while($rowd6 = mysqli_fetch_assoc($resd6)) {
                                                ...
                                                echo "<td class='text-center'><a href='view-barcode-data.php?id=$rowd6[EventCode]'><i class='fa fa-barcode'></i></a></tr>"; 
