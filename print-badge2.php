...
<html lang="en">
  ...
  <script>
        window.onafterprint = function(event) {
            location.href="view-badge.php?id=<?php echo $_GET['id']; ?>";
        };
  </script>
      <div class="container-fluid">
      <?php
        $res = mysqli_query($conn, "SELECT * FROM badge_master WHERE BD_Id = '$_GET[id]'");
        if(mysqli_num_rows($res)>0){
            while($row = mysqli_fetch_assoc($res)){
            ?>
                <div class="row mt-2" style="break-after:page">
                    <div class="col-4">
                    </div>
                    <div class="col-4 mt-4">
                        <div class="card text-center border-0">
                            <div class="card-body text-center" style="margin-left: auto;margin-right: auto;">
                                ...
                                <h6 class="card-subtitle mb-3 text-muted"><?php echo $row['Designation'];?></h6>
