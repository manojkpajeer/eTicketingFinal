            ...
            if(mysqli_num_rows($resBar)>0){
                ...
                while ($rowBar = mysqli_fetch_assoc($resBar)) {
                    ...
                    ?>
                        ...
                        <div class="col-5 row" style="font-size: 12px;">
                            <div class="col-6">
                            ...
                            <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?php echo $rowBar['Barcode'];?>&choe=UTF-8" title="DXB Tickets" height="150" width="150"/>
                            </div>
                                <span>
                                <?php 
