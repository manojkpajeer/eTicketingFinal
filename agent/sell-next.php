        ...
        <div class="row">
            <div class="col-xl-12 pr-xl-12">
                <div class="card card_border border-primary-top">
                    <div class="card-header chart-grid__header">Create Customer</div>
                        <div class="card-body">
                            <div class="row px-3">
                                <form method="post" class="row needs-validation" novalidate>
                                    <div class="col-md-4">
                                        <label for="validationCustom01" class="form-label">Saluation</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">Email ID <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">International Code</label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">Phone (max 10 digit)<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">Area Code</label>
                                            <input type="text" class="form-control input-style" id="validationCustom02" name="area_code" maxlength="10">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">Nationality <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">Date Of birth <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control input-style" id="validationCustom02" name="dateofbirth" max="<?php echo date('Y-m-d'); ?>" required>
                                            <div class="invalid-feedback">
                                            Choose birth date
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">City <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">State <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="validationCustom02" class="form-label">Country <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12 mt-4">
                                        <button class="btn btn-primary btn-style" type="submit" name="add">Create</button>
                                    </div>
                                </form>
                            </div>
                        </div>
