<?php 
    ...
    if (isset($_POST['reset'])) {
        ...
        $res = mysqli_query($conn, "SELECT login_master.UserPassword, ajent_master.FullName  FROM login_master JOIN ajent_master ON ajent_master.AjentEmail = login_master.UserEmail WHERE login_master.UserEmail = '$email' AND ajent_master.AjentStatus = 1");
